...
<head>
    ...
    <title>Recovery & Wellness - PowerLift Gym</title>
    ...
    <style>
        ...
        .hero-section {
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1544126592-807daa215a05?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') center/cover;
...
<body>
    ...
    <header class="hero-section">
        <div class="container">
            <h1 class="text-gradient display-3" style="font-family: 'Orbitron';">RECOVERY & WELLNESS</h1>
            <p class="lead">Heal your body, refresh your mind.</p>
        </div>
    </header>
    <main class="container mb-5">
        <div class="content-card">
            <div class="row g-5">
                <div class="col-lg-7">
                    <h2 class="text-gradient mb-4">OPTIMAL RECOVERY</h2>
                    <p class="text-muted fs-5 mb-4">Training is only half the journey. Proper recovery is where the results happen. Our wellness suite is designed for ultimate rejuvenation.</p>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="feature-box">
                                <i class="fas fa-hot-tub text-info fs-3 mb-3"></i>
                                <h5>Sauna & Steam</h5>
                                <p class="small text-muted">Detoxify and relax your muscles after a hard session.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="feature-box">
                                <i class="fas fa-hand-holding-heart text-info fs-3 mb-3"></i>
                                <h5>Massage Therapy</h5>
                                <p class="small text-muted">Professional sports massage to improve blood flow and flexibility.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="p-4 rounded-4" style="background: rgba(0,240,255,0.05); border: 1px solid rgba(0,240,255,0.2);">
                        ...
                        <p class="small text-muted">Choose your recovery path.</p>
